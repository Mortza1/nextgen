...
b.length)for(D=[],g=ba=0;g<b.length;g++)D.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateWidth():0)),ba+=D[g],t+=b[g]?b[g].margin:0;else D.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));E.push(D);d=Math.round(h.x1+d+ca-(c[0]?("inside"===c[0].labelPlacement?c[0].labelEffectiveWidth+5:0)+("inside"===c[0].tickPlacement?c[0].tickLength:0):0));r=Math.round(Math.min(h.x2-ba-t+(b[0]?("inside"===b[0].labelPlacement?b[0].labelEffectiveWidth+5:0)+("inside"===b[0].tickPlacement?b[0].tickLength:
0):0),m.width-n));if(a&&0<a.length)for(y=[],g=W=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(r-d),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?a[g].titleMaxWidth:a[g].lineCoordinates.width),y.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateHeight():0)),W+=y[g],e+=a[g]&&!m.isNavigator?a[g].margin:0;else y.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():0));R.push(y);if(f&&0<f.length)for(x=
[],g=Y=0;g<f.length;g++)f[g]&&(f[g].lineCoordinates={}),f[g].lineCoordinates.width=Math.abs(r-d),f[g].title&&(f[g]._titleTextBlock.maxWidth=0<f[g].titleMaxWidth&&f[g].titleMaxWidth<f[g].lineCoordinates.width?f[g].titleMaxWidth:f[g].lineCoordinates.width),x.push(Math.ceil(f[g]?f[g].createLabelsAndCalculateHeight():0)),Y+=x[g],O+=f[g]&&!m.isNavigator?f[g].margin:0;else x.push(Math.ceil(f[0]?f[0].createLabelsAndCalculateHeight():0));T.push(x);if(a&&0<a.length)for(g=0;g<a.length;g++){if(a[g]){a[g].lineCoordinates.x1=
d;a[g].lineCoordinates.x2=r;if(a[g]._labels&&1<a[g]._labels.length){var H=t=0;t=a[g]._labels[1];H="dateTime"===a[g].valueType?a[g]._labels[a[g]._labels.length-2]:a[g]._labels[a[g]._labels.length-1];v=t.textBlock.width*Math.cos(Math.PI/180*Math.abs(t.textBlock.angle))+(t.textBlock.height-t.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(t.textBlock.angle));s=H.textBlock.width*Math.cos(Math.PI/180*Math.abs(H.textBlock.angle))+H.textBlock.height*Math.sin(Math.PI/180*Math.abs(H.textBlock.angle))}!a[g]||
(!a[g].labelAutoFit||l(J)||l(M)||m.isNavigator||m.stockChart)||(t=0,0<a[g].labelAngle?(k=s-(H.textBlock.height-H.textBlock._lineHeight/2)*Math.sin(Math.PI/180*H.textBlock.angle),M+k>r&&(a[g].convertPixelToValue(M)>=a[g].viewportMinimum&&a[g].convertPixelToValue(M)<=a[g].viewportMaximum)&&(t+=M+k-r-ba)):0>a[g].labelAngle?J-v<d&&J-v<a[g].viewportMinimum&&(N=d-(ca+a[g].tickLength+B+J-v+a[g].labelFontSize/2)):0===a[g].labelAngle&&(M+s>r&&(a[g].convertPixelToValue(M)>=a[g].viewportMinimum&&a[g].convertPixelToValue(M)<=
a[g].viewportMaximum)&&(t=M+s/2-r-ba),J-v<d&&J-v<a[g].viewportMinimum&&(N=d-ca-a[g].tickLength-B-J+v/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&0<t?r-=t:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<N?d+=N:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<N&&(d+=N),0<t&&(r-=t)));m.panEnabled?W=l(m.sessionVariables.axisX.height)||m.stockChart?m.sessionVariables.axisX.height=
W:m.sessionVariables.axisX.height:m.sessionVariables.axisX.height=W;t=Math.round(h.y2-W-e+U);k=Math.round(h.y2);a[g].lineCoordinates.width=r-d;a[g].lineCoordinates.y1=t;a[g].lineCoordinates.y2=t;a[g].bounds={x1:d,y1:t,x2:r,y2:k-(W+e-y[g]-U),width:r-d};a[g].bounds.height=a[g].bounds.y2-a[g].bounds.y1;"inside"===a[g].labelPlacement&&(a[g].lineCoordinates.y1=a[0].bounds.y1+U+(a[g].labelEffectiveHeight||0)+5,a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2);"inside"===a[g].tickPlacement&&
(a[g].lineCoordinates.y1+=a[g].tickLength,a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2)}U+=y[g]+a[g].margin}if(f&&0<f.length)for(g=0;g<f.length;g++)f[g].lineCoordinates.x1=d,f[g].lineCoordinates.x2=r,f[g].lineCoordinates.width=Math.abs(r-d),f[g]._labels&&1<f[g]._labels.length&&(t=f[g]._labels[1],H="dateTime"===f[g].valueType?f[g]._labels[f[g]._labels.length-2]:f[g]._labels[f[g]._labels.length-1],v=t.textBlock.width*Math.cos(Math.PI/180*Math.abs(t.textBlock.angle))+(t.textBlock.height-
H.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(t.textBlock.angle)),s=H.textBlock.width*Math.cos(Math.PI/180*Math.abs(H.textBlock.angle))+(H.textBlock.height-H.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(H.textBlock.angle))),m.panEnabled?Y=l(m.sessionVariables.axisX2.height)||m.stockChart?m.sessionVariables.axisX2.height=Y:m.sessionVariables.axisX2.height:m.sessionVariables.axisX2.height=Y,t=Math.round(h.y1),k=f[g].lineCoordinates.y1=t+Y+O-Z,f[g].lineCoordinates.y2=t,f[g].bounds={x1:d,
y1:t+(Y+O-x[g]-Z),x2:r,y2:k,width:r-d},f[g].bounds.height=f[g].bounds.y2-f[g].bounds.y1,"inside"===f[g].labelPlacement&&(f[g].lineCoordinates.y1=f[0].bounds.y2-Z-(f[g].labelEffectiveHeight||0)-5),"inside"===f[g].tickPlacement&&(f[g].lineCoordinates.y1-=f[g].tickLength),Z+=x[g]+f[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)ca=m.isNavigator?0:10,c[g]&&(d=r=Math.round((a[0]?a[0].lineCoordinates.x1:f[0].lineCoordinates.x1)+(c[0]?("inside"===c[0].labelPlacement?c[0].labelEffectiveWidth+5:0)+("inside"===
c[0].tickPlacement?c[0].tickLength:0):0)),ca=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock._lineHeight/2:n,t=Math.round(Math.max(h.y1+Y+O-(f[0]?("inside"===f[0].labelPlacement?f[0].labelEffectiveHeight+5:0)+("inside"===f[0].tickPlacement?f[0].tickLength:0):0),Math.max(ca,n))),ca=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/2:n,k=Math.round(h.y2-W+(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveHeight+5:0)+("inside"===
a[0].tickPlacement?a[0].tickLength:0):0)-e-ca),c[g].lineCoordinates={x1:d-V,y1:t,x2:r-V,y2:k,height:Math.abs(k-t)},c[g].bounds={x1:d-(B[g]+V),y1:t,x2:r-V,y2:k,height:k-t},c[g].bounds.width=c[g].bounds.x2-c[g].bounds.x1,"inside"===c[g].labelPlacement&&(c[g].lineCoordinates.x1=c[0].bounds.x1+B[0]-V-(c[g].labelEffectiveWidth||0)-5,c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),"inside"===c[g].tickPlacement&&(c[g].lineCoordinates.x1-=c[g].tickLength,c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+
c[g].lineThickness/2),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),V+=B[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(d=r=Math.round((a[0]?a[0].lineCoordinates.x2:f[0].lineCoordinates.x2)-(b[0]?("inside"===b[0].labelPlacement?b[0].labelEffectiveWidth+5:0)+("inside"===b[0].tickPlacement?b[0].tickLength:0):0)),ca=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-
1].textBlock.height/2:0,t=Math.round(Math.max(h.y1+Y+O-(f[0]?("inside"===f[0].labelPlacement?f[0].labelEffectiveHeight+5:0)+("inside"===f[0].tickPlacement?f[0].tickLength:0):0),Math.max(ca,n))),ca=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(h.y2-(W+e+ca)+(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveHeight+5:0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0)),b[g].lineCoordinates={x1:d+X,y1:t,x2:d+X,y2:k,height:Math.abs(k-t)},
b[g].bounds={x1:d+X,y1:t,x2:r+D[g]+X,y2:k,height:k-t},b[g].bounds.width=b[g].bounds.x2-b[g].bounds.x1,"inside"===b[g].labelPlacement&&(b[g].lineCoordinates.x1=b[0].bounds.x1+X+(b[g].labelEffectiveWidth||0)+5,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),"inside"===b[g].tickPlacement&&(b[g].lineCoordinates.x1+=b[g].tickLength,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<
b[g].lineCoordinates.height?b[g].titleMaxWidth:b[g].lineCoordinates.height),X+=D[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++)a[g]&&(a[g].calculateValueToPixelConversionParameters(),a[g].calculateBreaksSizeInValues(),a[g]._labels&&1<a[g]._labels.length&&(J=(a[g].logarithmic?Math.log(a[g]._labels[1].position/a[g].viewportMinimum)/a[g].conversionParameters.lnLogarithmBase:a[g]._labels[1].position-a[g].viewportMinimum)*Math.abs(a[g].conversionParameters.pixelPerUnit)+a[g].lineCoordinates.x1,
d=a[g]._labels[a[g]._labels.length-("dateTime"===a[g].valueType?2:1)].position,d=a[g].getApparentDifference(a[g].viewportMinimum,d),M=a[g].logarithmic?(1<d?Math.log(d)/a[g].conversionParameters.lnLogarithmBase*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1:(0<d?d*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1));if(f&&0<f.length)for(g=0;g<f.length;g++)f[g].calculateValueToPixelConversionParameters(),f[g].calculateBreaksSizeInValues(),f[g]._labels&&
1<f[g]._labels.length&&(J=(f[g].logarithmic?Math.log(f[g]._labels[1].position/f[g].viewportMinimum)/f[g].conversionParameters.lnLogarithmBase:f[g]._labels[1].position-f[g].viewportMinimum)*Math.abs(f[g].conversionParameters.pixelPerUnit)+f[g].lineCoordinates.x1,d=f[g]._labels[f[g]._labels.length-("dateTime"===f[g].valueType?2:1)].position,d=f[g].getApparentDifference(f[g].viewportMinimum,d),M=f[g].logarithmic?(1<d?Math.log(d)/f[g].conversionParameters.lnLogarithmBase*Math.abs(f[g].conversionParameters.pixelPerUnit):
0)+f[g].lineCoordinates.x1:(0<d?d*Math.abs(f[g].conversionParameters.pixelPerUnit):0)+f[g].lineCoordinates.x1);for(g=0;g<p.length;g++)"axisY"===p[g].type&&(p[g].calculateValueToPixelConversionParameters(),p[g].calculateBreaksSizeInValues());if(0<u){if(a&&0<a.length)for(g=0;g<a.length;g++)w=R[u-1][g]===R[u][g]?!0:!1;else w=!0;if(f&&0<f.length)for(g=0;g<f.length;g++)L=T[u-1][g]===T[u][g]?!0:!1;else L=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)P=S[u-1][g]===S[u][g]?!0:!1;else P=!0;if(b&&0<b.length)for(g=
0;g<b.length;g++)Q=E[u-1][g]===E[u][g]?!0:!1;else Q=!0}if(w&&L&&P&&Q)break;u++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(f&&0<f.length)for(g=0;g<f.length;g++)f[g].calculateStripLinesThicknessInValues(),f[g].calculateBreaksInPixels();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),
b[g].calculateBreaksInPixels()}else{n=[];J=[];N=[];v=[];s=[];M=[];R=[];for(T=[];4>u;){W=X=V=t=ca=O=e=E=S=U=Y=0;if(a&&0<a.length)for(N=[],g=X=0;g<a.length;g++)N.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),X+=N[g],e+=a[g]&&!m.isNavigator?a[g].margin:0;else N.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));R.push(N);if(f&&0<f.length)for(v=[],g=W=0;g<f.length;g++)v.push(Math.ceil(f[g]?f[g].createLabelsAndCalculateWidth():0)),W+=v[g],O+=f[g]?f[g].margin:0;else v.push(Math.ceil(f[0]?
f[0].createLabelsAndCalculateWidth():0));T.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},d=Math.round(h.x1+X+e-(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveWidth+5:0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0)),r=Math.round(Math.min(h.x2-W-O+(f[0]?("inside"===f[0].labelPlacement?f[0].labelEffectiveWidth+5:0)+("inside"===f[0].tickPlacement?f[0].tickLength:0):0),m.width-10)),c[g].labelAutoFit&&!l(y)&&(0<!a.length&&(d=0>c[g].labelAngle?Math.max(d,y):0===
c[g].labelAngle?Math.max(d,y/2):d),0<!f.length&&(r=0<c[g].labelAngle?r-x/2:0===c[g].labelAngle?r-x/2:r)),c[g].lineCoordinates.x1=d,c[g].lineCoordinates.x2=r,c[g].lineCoordinates.width=Math.abs(r-d),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},d=Math.round(h.x1+X+e-(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveWidth+
5:0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0)),r=Math.round(Math.min(h.x2-W-O+(f[0]?("inside"===f[0].labelPlacement?f[0].labelEffectiveWidth+5:0)+("inside"===f[0].tickPlacement?f[0].tickLength:0):0),b[g].chart.width-10)),b[g]&&b[g].labelAutoFit&&!l(B)&&(0<!a.length&&(d=0<b[g].labelAngle?Math.max(d,B):0===b[g].labelAngle?Math.max(d,B/2):d),0<!f.length&&(r-=D/2)),b[g].lineCoordinates.x1=d,b[g].lineCoordinates.x2=r,b[g].lineCoordinates.width=Math.abs(r-d),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(n=[],g=V=0;g<c.length;g++)n.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),V+=n[g]+c[g].margin,ca+=c[g].margin;else n.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));s.push(n);if(b&&0<b.length)for(J=[],g=0;g<b.length;g++)J.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),t+=b[g].margin;else J.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateHeight():
...
0<b[g]._labels.length&&(t=b[g]._labels[0],H=b[g]._labels[b[g]._labels.length-1],B=t.textBlock.width*Math.cos(Math.PI/180*Math.abs(t.textBlock.angle))+(t.textBlock.height-H.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(t.textBlock.angle)),D=H.textBlock.width*Math.cos(Math.PI/180*Math.abs(H.textBlock.angle))+(H.textBlock.height-H.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(H.textBlock.angle)));if(m.panEnabled)for(g=0;g<c.length;g++)n[g]=l(m.sessionVariables.axisY[g].height)?m.sessionVariables.axisY[g].height=
n[g]:m.sessionVariables.axisY[g].height;else for(g=0;g<c.length;g++)m.sessionVariables.axisY[g].height=n[g];if(c&&0<c.length)for(g=c.length-1;0<=g;g--)t=Math.round(h.y2),k=Math.round(h.y2>c[g].chart.height?c[g].chart.height:h.y2),c[g].lineCoordinates.y1=t-(n[g]+c[g].margin+Y),c[g].lineCoordinates.y2=t-(n[g]+c[g].margin+Y),"inside"===c[g].labelPlacement&&(c[g].lineCoordinates.y1=c[g].lineCoordinates.y1+c[g].labelEffectiveHeight+5,c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),
"inside"===c[g].tickPlacement&&(c[g].lineCoordinates.y1+=c[g].tickLength,c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:d,y1:t-(n[g]+Y+c[g].margin),x2:r,y2:k-(Y+c[g].margin),width:r-d,height:n[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),Y+=n[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(t=Math.round(h.y1),k=Math.round(h.y1+
(J[g]+b[g].margin+U)),b[g].lineCoordinates.y1=k,b[g].lineCoordinates.y2=k,"inside"===b[g].labelPlacement&&(b[g].lineCoordinates.y1=k-b[g].labelEffectiveHeight-5,b[g].lineCoordinates.y2=b[g].lineCoordinates.y1-b[g].lineThickness/2),"inside"===b[g].tickPlacement&&(b[g].lineCoordinates.y1-=b[g].tickLength,b[g].lineCoordinates.y2=b[g].lineCoordinates.y1-b[g].lineThickness/2),b[g].bounds={x1:d,y1:t+(b[g].margin+U),x2:r,y2:k,width:r-d},b[g].bounds.height=b[g].bounds.y2-b[g].bounds.y1,b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width),U+=J[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++){ca=a[g]._labels&&0<a[g]._labels.length?a[g]._labels[0].textBlock.fontSize/2:0;d=Math.round(h.x1+e);t=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:h.y1<Math.max(ca,10)?Math.max(ca,10):h.y1):h.y1<Math.max(ca,10)?Math.max(ca,10):h.y1;r=Math.round(h.x1+X+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:h.y2-
V>m.height-Math.max(ca,10)?m.height-Math.max(ca,10):h.y2-V):h.y2>m.height-Math.max(ca,10)?m.height-Math.max(ca,10):h.y2;if(c&&0<c.length)for(H=0;H<c.length;H++)c[H]&&c[H].labelAutoFit&&(r=c[H].lineCoordinates.x1+(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveWidth+5:0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0),d=0>c[H].labelAngle||0===c[H].labelAngle?r-X:d);if(b&&0<b.length)for(H=0;H<b.length;H++)b[H]&&b[H].labelAutoFit&&(r=b[H].lineCoordinates.x1+(a[0]?("inside"===a[0].labelPlacement?
a[0].labelEffectiveWidth+5:0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0),d=r-X);a[g].lineCoordinates={x1:r-S,y1:t,x2:r-S,y2:k,height:Math.abs(k-t)};"inside"===a[g].labelPlacement&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-a[g].labelEffectiveWidth-5,a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);"inside"===a[g].tickPlacement&&(a[g].lineCoordinates.x1-=a[g].tickLength,a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:r-(N[g]+
S),y1:t,x2:r-S,y2:k,height:k-t};a[g].bounds.width=a[g].bounds.x2-a[g].bounds.x1;a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();S+=N[g]+a[g].margin}if(f&&0<f.length)for(g=0;g<f.length;g++){ca=f[g]._labels&&0<f[g]._labels.length?f[g]._labels[0].textBlock.fontSize/2:0;r=Math.round(h.x1-O);t=b&&0<b.length?Math.round(b[0]?
b[0].lineCoordinates.y2:h.y1<Math.max(ca,10)?Math.max(ca,10):h.y1):h.y1<Math.max(ca,10)?Math.max(ca,10):h.y1;d=Math.round(h.x2-W-O);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:h.y2-V>m.height-Math.max(ca,10)?m.height-Math.max(ca,10):h.y2-V):h.y2>m.height-Math.max(ca,10)?m.height-Math.max(ca,10):h.y2;if(c&&0<c.length)for(H=0;H<c.length;H++)c[H]&&c[H].labelAutoFit&&(d=c[H].lineCoordinates.x2-(f[0]?("inside"===f[0].labelPlacement?f[0].labelEffectiveWidth+5:0)+("inside"===f[0].tickPlacement?
f[0].tickLength:0):0),r=0>c[H].labelAngle||0===c[H].labelAngle?d+W:d);if(b&&0<b.length)for(H=0;H<b.length;H++)b[H]&&b[H].labelAutoFit&&(d=b[H].lineCoordinates.x2-(f[0]?("inside"===f[0].labelPlacement?f[0].labelEffectiveWidth+5:0)+("inside"===f[0].tickPlacement?f[0].tickLength:0):0),r=d+W);f[g].lineCoordinates={x1:d+E,y1:t,x2:d+E,y2:k,height:Math.abs(k-t)};"inside"===f[g].labelPlacement&&(f[g].lineCoordinates.x1=f[g].lineCoordinates.x1+f[g].labelEffectiveWidth+5,f[g].lineCoordinates.x2=f[g].lineCoordinates.x1+
f[g].lineThickness/2);"inside"===f[g].tickPlacement&&(f[g].lineCoordinates.x1+=f[g].tickLength,f[g].lineCoordinates.x2=f[g].lineCoordinates.x1+f[g].lineThickness/2);f[g].bounds={x1:d+E,y1:t,x2:d+v[g]+E,y2:k,height:k-t};f[g].bounds.width=f[g].bounds.x2-f[g].bounds.x1;f[g].title&&(f[g]._titleTextBlock.maxWidth=0<f[g].titleMaxWidth&&f[g].titleMaxWidth<f[g].lineCoordinates.height?f[g].titleMaxWidth:f[g].lineCoordinates.height);f[g].calculateValueToPixelConversionParameters();f[g].calculateBreaksSizeInValues();
E+=v[g]+f[g].margin}for(g=0;g<p.length;g++)"axisY"===p[g].type&&(p[g].calculateValueToPixelConversionParameters(),p[g].calculateBreaksSizeInValues());if(0<u){if(a&&0<a.length)for(g=0;g<a.length;g++)w=R[u-1][g]===R[u][g]?!0:!1;else w=!0;if(f&&0<f.length)for(g=0;g<f.length;g++)L=T[u-1][g]===T[u][g]?!0:!1;else L=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)P=s[u-1][g]===s[u][g]?!0:!1;else P=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)Q=M[u-1][g]===M[u][g]?!0:!1;else Q=!0}if(w&&L&&P&&Q)break;u++}if(c&&0<
c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(f&&0<f.length)for(g=0;g<f.length;g++)f[g].calculateStripLinesThicknessInValues(),f[g].calculateBreaksInPixels()}};B.render=function(a,f,c,b,e){e=a[0]?a[0].chart:
f[0].chart;var h=e.ctx;e.alignVerticalAxes&&e.alignVerticalAxes();h.save();h.beginPath();a&&a.length&&h.rect(2,a[0].bounds.y1,a[0].chart.width-4,a[a.length-1].bounds.y2);f&&f.length&&h.rect(2,f[f.length-1].bounds.y1,f[0].chart.width-4,f[0].bounds.y2);h.clip();if(a&&0<a.length)for(var d=0;d<a.length;d++)a[d].renderLabelsTicksAndTitle();if(f&&0<f.length)for(d=0;d<f.length;d++)f[d].renderLabelsTicksAndTitle();h.restore();if(c&&0<c.length)for(d=0;d<c.length;d++)c[d].renderLabelsTicksAndTitle();if(b&&
0<b.length)for(d=0;d<b.length;d++)b[d].renderLabelsTicksAndTitle();e.preparePlotArea();d=e.plotArea;h.save();h.beginPath();h.rect(d.x1,d.y1,Math.abs(d.x2-d.x1),Math.abs(d.y2-d.y1));h.clip();if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].renderStripLinesOfThicknessType("value");if(f&&0<f.length)for(d=0;d<f.length;d++)f[d].renderStripLinesOfThicknessType("value");if(c&&0<c.length)for(d=0;d<c.length;d++)c[d].renderStripLinesOfThicknessType("value");if(b&&0<b.length)for(d=0;d<b.length;d++)b[d].renderStripLinesOfThicknessType("value");
if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].renderInterlacedColors();if(f&&0<f.length)for(d=0;d<f.length;d++)f[d].renderInterlacedColors();if(c&&0<c.length)for(d=0;d<c.length;d++)c[d].renderInterlacedColors();if(b&&0<b.length)for(d=0;d<b.length;d++)b[d].renderInterlacedColors();h.restore();if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].renderGrid(),r&&(a[d].createMask(),a[d].renderBreaksBackground());if(f&&0<f.length)for(d=0;d<f.length;d++)f[d].renderGrid(),r&&(f[d].createMask(),f[d].renderBreaksBackground());
...
p.y-(("inside"===this.tickPlacement?this.tickLength:0)+n.textBlock.height-n.textBlock._lineHeight/2+5):p.y+("inside"===this.tickPlacement?0:this.tickLength)+n.textBlock._lineHeight/2+5):0>this.labelAngle?(p.x=p.x-("inside"===this.labelPlacement?0:n.textBlock.width*Math.cos(Math.PI/180*this.labelAngle))+n.textBlock.topPadding*Math.sin(Math.PI/180*this.labelAngle),p.y="inside"===this.labelPlacement?p.y-("inside"===this.tickPlacement?this.tickLength:0)-5-(n.textBlock.height-n.textBlock._lineHeight/2)*
Math.cos(Math.PI/180*this.labelAngle):p.y+("inside"===this.tickPlacement?0:this.tickLength)+5+Math.abs(n.textBlock.width*Math.sin(Math.PI/180*this.labelAngle)-n.textBlock._lineHeight/2*Math.cos(Math.PI/180*this.labelAngle))):(p.x=p.x-("inside"===this.labelPlacement?n.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0)+n.textBlock.topPadding*Math.sin(Math.PI/180*this.labelAngle),p.y="inside"===this.labelPlacement?p.y-("inside"===this.tickPlacement?this.tickLength:0)-5-n.textBlock.width*Math.sin(Math.PI/
180*this.labelAngle)-(n.textBlock.height-n.textBlock._lineHeight/2)*Math.cos(Math.PI/180*this.labelAngle):p.y+("inside"===this.tickPlacement?0:this.tickLength)+5+Math.abs(n.textBlock._lineHeight/2*Math.cos(Math.PI/180*this.labelAngle))),n.textBlock.x=p.x,n.textBlock.y=p.y));"inside"===this.tickPlacement&&this.chart.addEventListener("dataAnimationIterationEnd",function(){for(k=0;k<a._labels.length;k++)if(n=a._labels[k],!(n.position<a.viewportMinimum||n.position>a.viewportMaximum)&&(p=a.getPixelCoordinatesOnAxis(n.position),
...
this.ctx.lineTo(b,p.y-this.tickLength<<0),this.ctx.stroke()),f&&0!==h++%2&&this.labelAutoFit||(0===n.textBlock.angle?(p.x-=n.textBlock.width/2,p.y="inside"===this.labelPlacement?p.y+n.textBlock._lineHeight/2+("inside"===this.tickPlacement?this.tickLength:0)+5:p.y-(("inside"===this.tickPlacement?0:this.tickLength)+n.textBlock.height-n.textBlock._lineHeight/2)-5):0>this.labelAngle?(p.x=p.x-("inside"===this.labelPlacement?n.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0)+n.textBlock.topPadding*
...
0<this.stripLines.length&&a){var f=this,c,b,e=0,h=0,d=!1;b=!1;for(var r=[],u=[],k=!1,m,e=0;e<this.stripLines.length;e++){var n=this.stripLines[e];n._thicknessType===a&&("pixel"===a&&(n.value<this.viewportMinimum||n.value>this.viewportMaximum||l(n.value)||isNaN(this.range))||"value"===a&&(n.startValue<=this.viewportMinimum&&n.endValue<=this.viewportMinimum||n.startValue>=this.viewportMaximum&&n.endValue>=this.viewportMaximum||l(n.startValue)||l(n.endValue)||isNaN(this.range))||r.push(n))}for(e=0;e<
...
this.ctx.restore()},n)):n.render();for(e=0;e<u.length;e++)c=u[e],c.stripLine.showOnTop?b||(b=!0,this.chart.addEventListener("dataAnimationIterationEnd",function(){for(h=0;h<u.length;h++)c=u[h],"inside"===c.stripLine.labelPlacement&&c.stripLine.showOnTop&&(f.ctx.save(),f.ctx.beginPath(),f.ctx.rect(f.chart.plotArea.x1,f.chart.plotArea.y1,f.chart.plotArea.width,f.chart.plotArea.height),f.ctx.clip(),c.textBlock.render(!0),f.ctx.restore())},c.textBlock)):"inside"===c.stripLine.labelPlacement&&c.textBlock.render(!0);
this.ctx.restore();k=!0}if(k)for(b=!1,e=0;e<u.length;e++)c=u[e],"outside"===c.stripLine.labelPlacement&&c.textBlock.render(!0)}};B.prototype.renderBreaksBackground=function(){this.chart._breaksCanvas&&(this.scaleBreaks&&0<this.scaleBreaks._appliedBreaks.length&&this.maskCanvas)&&(this.chart._breaksCanvasCtx.save(),this.chart._breaksCanvasCtx.beginPath(),this.chart._breaksCanvasCtx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height),this.chart._breaksCanvasCtx.clip(),
this.chart._breaksCanvasCtx.drawImage(this.maskCanvas,0,0,this.chart.width,this.chart.height),this.chart._breaksCanvasCtx.restore())};B.prototype.createMask=function(){if(this.scaleBreaks&&0<this.scaleBreaks._appliedBreaks.length){var a=this.scaleBreaks._appliedBreaks;r?(this.maskCanvas=ta(this.chart.width,this.chart.height),this.maskCtx=this.maskCanvas.getContext("2d")):(this.maskCanvas=this.chart.plotArea.canvas,this.maskCtx=this.chart.plotArea.ctx);this.maskCtx.save();this.maskCtx.beginPath();
this.maskCtx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.maskCtx.clip();for(var f=0;f<a.length;f++)a[f].endValue<this.viewportMinimum||(a[f].startValue>this.viewportMaximum||isNaN(this.range))||a[f].render(this.maskCtx);this.maskCtx.restore()}};B.prototype.renderCrosshair=function(a,f){isFinite(this.minimum)&&isFinite(this.maximum)&&this.crosshair.render(a,f)};B.prototype.showCrosshair=function(a){l(a)||(a<this.viewportMinimum||a>this.viewportMaximum)||
("top"===this._position||"bottom"===this._position?this.crosshair.render(this.convertValueToPixel(a),null,a):this.crosshair.render(null,this.convertValueToPixel(a),a))};B.prototype.renderGrid=function(){if(this.gridThickness&&0<this.gridThickness){var a=this.chart.ctx;a.save();var f,c=this.chart.plotArea;a.lineWidth=this.gridThickness;a.strokeStyle=this.gridColor;a.setLineDash&&a.setLineDash(J(this.gridDashType,this.gridThickness));if("bottom"===this._position||"top"===this._position)for(b=0;b<this._labels.length;b++)this._labels[b].position<
...
e[h].startValue)):!b&&(a>e[h].startValue&&f<e[h].endValue)&&(c=a*Math.pow(e[h].size,Math.log(f/a)/Math.log(e[h].endValue/e[h].startValue))))}else for(c=l(c)?Math.abs(f-a):c,h=0;h<e.length&&!(f<e[h].startValue);h++)a>e[h].endValue||(a<=e[h].startValue&&f>=e[h].endValue?c=c-e[h].endValue+e[h].startValue+e[h].size:a>e[h].startValue&&f>=e[h].endValue?c=c-e[h].endValue+a+e[h].size*(e[h].endValue-a)/(e[h].endValue-e[h].startValue):a<=e[h].startValue&&f<e[h].endValue?c=c-f+e[h].startValue+e[h].size*(f-e[h].startValue)/
(e[h].endValue-e[h].startValue):!b&&(a>e[h].startValue&&f<e[h].endValue)&&(c=a+e[h].size*(f-a)/(e[h].endValue-e[h].startValue)));return c};B.prototype.setViewPortRange=function(a,f){this.sessionVariables.newViewportMinimum=this.viewportMinimum=Math.min(a,f);this.sessionVariables.newViewportMaximum=this.viewportMaximum=Math.max(a,f)};B.prototype.getXValueAt=function(a){if(!a)return null;var f=null;"left"===this._position?f=this.convertPixelToValue(a.y):"bottom"===this._position&&(f=this.convertPixelToValue(a.x));
return f};B.prototype.calculateValueToPixelConversionParameters=function(a){a=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];var f={pixelPerUnit:null,minimum:null,reference:null},c=this.lineCoordinates.width,b=this.lineCoordinates.height,c="bottom"===this._position||"top"===this._position?c:b,b=Math.abs(this.range);if(this.logarithmic)for(var e=0;e<a.length&&!(this.viewportMaximum<a[e].startValue);e++)this.viewportMinimum>a[e].endValue||(this.viewportMinimum>=a[e].startValue&&this.viewportMaximum<=
...
c=!1;"bottom"===this._position||"top"===this._position?(this.maxWidth=a.width,this.maxHeight=a.height):(this.maxWidth=a.height,this.maxHeight=a.width);var a="axisX"===this.type?"xySwapped"===this.chart.plotInfo.axisPlacement?62:70:"xySwapped"===this.chart.plotInfo.axisPlacement?50:40,b=4;"axisX"===this.type&&(b=600>this.maxWidth?8:6);var a=Math.max(b,Math.floor(this.maxWidth/a)),e,h,d,b=0;!l(this.options.viewportMinimum)&&(!l(this.options.viewportMaximum)&&this.options.viewportMinimum>=this.options.viewportMaximum)&&
...
(!l(this.sessionVariables.newViewportMaximum)&&this.sessionVariables.newViewportMaximum<=this.scaleBreaks._appliedBreaks[b].endValue||!l(this.options.maximum)&&this.options.maximum<=this.scaleBreaks._appliedBreaks[b].endValue||!l(this.options.viewportMaximum)&&this.viewportMaximum<=this.scaleBreaks._appliedBreaks[b].endValue)){this.scaleBreaks._appliedBreaks.splice(b,1);break}if("axisX"===this.type){if(this.dataSeries&&0<this.dataSeries.length)for(e=0;e<this.dataSeries.length;e++)"dateTime"===this.dataSeries[e].xValueType&&
...
null===this.maximum&&(this.maximum="axisX"===this.type?h+d/2:Math.ceil(h/this.interval)*this.interval,this.maximum=Math.max(this.maximum,null===this.sessionVariables.viewportMaximum||isNaN(this.sessionVariables.viewportMaximum)?-Infinity:this.sessionVariables.viewportMaximum)),0===this.maximum&&0===this.minimum&&(0===this.options.minimum?this.maximum+=10:0===this.options.maximum&&(this.minimum-=10));l(this.sessionVariables.newViewportMinimum)&&(this.viewportMinimum=Math.max(this.viewportMinimum,this.minimum));
...
isNaN(this.viewportMaximum))this.viewportMaximum=this.maximum;if(this.scaleBreaks)for(d=0;d<this.scaleBreaks._appliedBreaks.length;d++)if((!l(this.sessionVariables.newViewportMinimum)&&this.sessionVariables.newViewportMinimum>=this.scaleBreaks._appliedBreaks[d].startValue||!l(this.options.minimum)&&this.options.minimum>=this.scaleBreaks._appliedBreaks[d].startValue||!l(this.options.viewportMinimum)&&this.viewportMinimum>=this.scaleBreaks._appliedBreaks[d].startValue)&&(!l(this.sessionVariables.newViewportMaximum)&&
this.sessionVariables.newViewportMaximum<=this.scaleBreaks._appliedBreaks[d].endValue||!l(this.options.maximum)&&this.options.maximum<=this.scaleBreaks._appliedBreaks[d].endValue||!l(this.options.viewportMaximum)&&this.viewportMaximum<=this.scaleBreaks._appliedBreaks[d].endValue)){this.scaleBreaks._appliedBreaks.splice(d,1);break}"axisX"===this.type?(b=null!==this.viewportMinimum?this.viewportMinimum:this.dataInfo.viewPortMin,e=null!==this.viewportMaximum?this.viewportMaximum:this.dataInfo.viewPortMax,
...
f/this.interval)),l(null===this.sessionVariables.viewportMinimum||isNaN(this.sessionVariables.viewportMinimum)?"undefined"===typeof this.sessionVariables.newViewportMinimum?Infinity:this.sessionVariables.newViewportMinimum:this.sessionVariables.viewportMinimum)||(this.minimum=Math.min(this.minimum,null===this.sessionVariables.viewportMinimum||isNaN(this.sessionVariables.viewportMinimum)?"undefined"===typeof this.sessionVariables.newViewportMinimum?Infinity:this.sessionVariables.newViewportMinimum:
...
B.prototype.getLabelStartPoint=function(){var a=T[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));else if("minute"===this.intervalType){if(0<a.getSeconds()||0<a.getMilliseconds())a.setMinutes(a.getMinutes()+1),a.setSeconds(0),a.setMilliseconds(0)}else if("hour"===this.intervalType){if(0<a.getMinutes()||0<a.getSeconds()||
...
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;U(this.id);var h,d,l,r,k,m;a=Math.max(this.spacing,3);var n=Math.max(0,this.lineThickness);this.ctx.lineWidth=n;this.ctx.setLineDash&&this.ctx.setLineDash(J(this.lineDashType,n));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===n%2?(b.x<<0)+0.5:b.x<<0,d=1===n%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,l=this.chart.plotArea.y2+
n/2+0.5<<0):(e=this.chart.plotArea.y2,l=this.chart.plotArea.y1-n/2+0.5<<0,a*=-1),this.bounds={x1:b-n/2,y1:e,x2:d+n/2,y2:l},this.ctx.moveTo(b,e),"straight"===this.type||"top"===this.scaleBreaks.parent._position&&0>=a||"bottom"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(b,l),this.ctx.lineTo(d,l),this.ctx.lineTo(d,e);else if("wavy"===this.type){r=b;k=e;h=0.5;m=(l-k)/a/3;for(var p=0;p<m;p++)this.ctx.bezierCurveTo(r+h*a,k+a,r+h*a,k+2*a,r,k+3*a),k+=3*a,h*=-1;this.ctx.bezierCurveTo(r+h*a,
k+a,r+h*a,k+2*a,r,k+3*a);r=d;h*=-1;this.ctx.lineTo(r,k);for(p=0;p<m;p++)this.ctx.bezierCurveTo(r+h*a,k-a,r+h*a,k-2*a,r,k-3*a),k-=3*a,h*=-1}else{if("zigzag"===this.type){h=-1;k=e+a;r=b+a;m=(l-k)/a/2;for(p=0;p<m;p++)this.ctx.lineTo(r,k),r+=2*h*a,k+=2*a,h*=-1;this.ctx.lineTo(r,k);r+=d-b;for(p=0;p<m+1;p++)this.ctx.lineTo(r,k),r+=2*h*a,k-=2*a,h*=-1;this.ctx.lineTo(r+h*a,k+a)}}else if("left"===this.scaleBreaks.parent._position||"right"===this.scaleBreaks.parent._position)if(e=1===n%2?(e.y<<0)+0.5:e.y<<
0,l=1===n%2?(b.y<<0)+0.5:b.y<<0,"left"===this.scaleBreaks.parent._position?(b=this.chart.plotArea.x1,d=this.chart.plotArea.x2+n/2+0.5<<0):(b=this.chart.plotArea.x2,d=this.chart.plotArea.x1-n/2+0.5<<0,a*=-1),this.bounds={x1:b,y1:e-n/2,x2:d,y2:l+n/2},this.ctx.moveTo(b,e),"straight"===this.type||"left"===this.scaleBreaks.parent._position&&0>=a||"right"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(d,e),this.ctx.lineTo(d,l),this.ctx.lineTo(b,l);else if("wavy"===this.type){r=b;k=e;h=0.5;m=
(d-r)/a/3;for(p=0;p<m;p++)this.ctx.bezierCurveTo(r+a,k+h*a,r+2*a,k+h*a,r+3*a,k),r+=3*a,h*=-1;this.ctx.bezierCurveTo(r+a,k+h*a,r+2*a,k+h*a,r+3*a,k);k=l;h*=-1;this.ctx.lineTo(r,k);for(p=0;p<m;p++)this.ctx.bezierCurveTo(r-a,k+h*a,r-2*a,k+h*a,r-3*a,k),r-=3*a,h*=-1}else if("zigzag"===this.type){h=1;k=e-a;r=b+a;m=(d-r)/a/2;for(p=0;p<m;p++)this.ctx.lineTo(r,k),k+=2*h*a,r+=2*a,h*=-1;this.ctx.lineTo(r,k);k+=l-e;for(p=0;p<m+1;p++)this.ctx.lineTo(r,k),k+=2*h*a,r-=2*a,h*=-1;this.ctx.lineTo(r+a,k+h*a)}0<n&&this.ctx.stroke();
