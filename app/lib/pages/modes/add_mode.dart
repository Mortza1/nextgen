...
class AddModeScreen extends StatefulWidget {
  ...
  const AddModeScreen({super.key, required this.model, required this.modeModel, required this.appModel});
...
class AddModeScreenState extends State<AddModeScreen> {
  ...
  Widget _settingOptions() {
    List pages = [_name(), _devices(widget.model), _time(), _days(), _deviceModification(widget.model), _personalization()];
    List next = ['Choose devices', 'Choose time', 'Choose days', 'Device setup', 'personalization', 'Done'];
    double width = (state + 1)/6;
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(50),
                        color: state == 5 ? Colors.greenAccent : Colors.white,
                        boxShadow: [
                          BoxShadow(
                            color: Colors.black.withOpacity(0.2), // Shadow color with transparency
                            spreadRadius: 2, // Spread radius
                      ...
                      child: Center(
                        child: Icon(state == 5 ? Icons.check : Icons.arrow_downward, color: Colors.black,),
                      ),
                    ),
                  )
                ],
  ...
  Widget _personalization(){
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Choose a background color for your mode",
            style: TextStyle(fontSize: 17),
          ),
          Expanded(
            child: GridView.builder(
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: Color(0x96C2C3CD), width: 3)
                    ),
                  ),
                );
              },
          ...
          Text('Preview', style: TextStyle(fontSize: 17),),
          SizedBox(height: 10,),
          Container(
            height: MediaQuery.of(context).size.height * 0.14,
            width: MediaQuery.of(context).size.width,
            ...
            child: Center(
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(_textController.text, style: const TextStyle(
                    fontSize: 22,
                    fontFamily: 'Roboto',
